...
namespace DAL.Core
{
    ...
    class MesaDAL
    {
        ...
        public MesaDAL(ModelContext db)
        {
            this.db = db;
        }

        internal pedidomesa InserePedidoEmMesa(mesa mesa, string senha)
        {
            try
            {
        ...
        /// <returns></returns>
        public mesa PegaMesaPorId(int mesaId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<MesaDTO> listaMesas(string nomeMesa = null)
        {
